...
/**
 * @class CSE6SSM_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class CSE6SSM_slha<Two_scale> : public CSE6SSM<Two_scale> {
public:
   explicit CSE6SSM_slha(const CSE6SSM_input_parameters<Two_scale>& input_
                         = CSE6SSM_input_parameters<Two_scale>());
   explicit CSE6SSM_slha(const CSE6SSM<Two_scale>&);
   virtual ~CSE6SSM_slha();
   ...
   CSE6SSM_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
   const CSE6SSM_physical& get_drbar_slha() const; ///< returns DR-bar masses to SLHA convention
   CSE6SSM_physical& get_drbar_slha(); ///< returns DR-bar masses to SLHA convention
