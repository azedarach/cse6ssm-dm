 ...
 */
double CSE6SSM_susy_parameters::calc_beta_KappaPr_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CSE6SSM_susy_parameters::calc_beta_KappaPr_two_loop(const Susy_traces& susy_traces) const
{
