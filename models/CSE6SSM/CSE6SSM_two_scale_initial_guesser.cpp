...
CSE6SSM_initial_guesser<Two_scale>::CSE6SSM_initial_guesser(
   CSE6SSM<Two_scale>* model_,
   const QedQcd& oneset_,
   const CSE6SSM_low_scale_constraint<Two_scale>& low_constraint_,
   const CSE6SSM_susy_scale_constraint<Two_scale>& susy_constraint_,
   const CSE6SSM_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "CSE6SSM_initial_guesser: Error: pointer to model"
          " CSE6SSM<Two_scale> must not be zero");
}
 ...
 */
void CSE6SSM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void CSE6SSM_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void CSE6SSM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void CSE6SSM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void CSE6SSM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void CSE6SSM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void CSE6SSM_initial_guesser<Two_scale>::guess_soft_parameters()
{
