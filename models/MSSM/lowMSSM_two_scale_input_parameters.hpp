...
// File generated at Wed 15 Jul 2015 13:12:10

#ifndef lowMSSM_TWO_SCALE_INPUT_PARAMETERS_H
#define lowMSSM_TWO_SCALE_INPUT_PARAMETERS_H
...
template<>
struct lowMSSM_input_parameters<Two_scale> {
   double TanBeta;
   double MuInput;
...
std::ostream& operator<<(std::ostream&, const lowMSSM_input_parameters<Two_scale>&);
