...
public:
   ...
   void fill(lowMSSM_input_parameters<Two_scale>&) const;
   ...
   void set_extpar(const lowMSSM_input_parameters<Two_scale>&);
   template <class T> void set_extra(const lowMSSM_slha<T>&, const lowMSSM_scales&);
   void set_minpar(const lowMSSM_input_parameters<Two_scale>&);
   ...
   static void fill_minpar_tuple(lowMSSM_input_parameters<Two_scale>&, int, double);
   static void fill_extpar_tuple(lowMSSM_input_parameters<Two_scale>&, int, double);
   ...
   const QedQcd& qedqcd, const lowMSSM_scales& scales)
{
   ...
   const lowMSSM_input_parameters<Two_scale>& input = model.get_input();
