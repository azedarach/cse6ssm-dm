 ...
 */
template<>
class lowMSSM<Two_scale> : public Two_scale_model, public MSSM_mass_eigenstates {
public:
   explicit lowMSSM(const lowMSSM_input_parameters<Two_scale>& input_ = lowMSSM_input_parameters<Two_scale>());
   virtual ~lowMSSM();
   ...
   const lowMSSM_input_parameters<Two_scale>& get_input() const;
   void set_input_parameters(const lowMSSM_input_parameters<Two_scale>&);
