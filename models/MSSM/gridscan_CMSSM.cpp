...
void set_default_parameter_values(CMSSM_input_parameters<Two_scale>& input)
{
   input.m0 = 1000.;
   input.m12 = 3500.;
   input.Azero = 8000.;
...
int main(int argc, const char* argv[])
{
   ...
   CMSSM_pole_mass_writer pole_mass_writer;
   CMSSM_drbar_values_writer drbar_values_writer;
   CMSSM_slha_values_writer slha_values_writer;
   ...
   while (!scan.has_finished()) {
      ...
      const CMSSM_slha<algorithm_type> model_slha(model);
