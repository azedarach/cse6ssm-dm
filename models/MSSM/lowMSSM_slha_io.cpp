 ...
 */
void lowMSSM_slha_io::set_extpar(const lowMSSM_input_parameters<Two_scale>& input)
{
 ...
 * @param input struct of input parameters
 */
void lowMSSM_slha_io::set_minpar(const lowMSSM_input_parameters<Two_scale>& input)
{
 ...
 */
void lowMSSM_slha_io::set_spinfo(const Problems<MSSM_info::NUMBER_OF_PARTICLES>& problems)
{
 ...
 */
void lowMSSM_slha_io::set_mass(const MSSM_physical& physical,
 ...
 */
void lowMSSM_slha_io::set_mixing_matrices(const MSSM_physical& physical,
 ...
 */
void lowMSSM_slha_io::fill(lowMSSM_input_parameters<Two_scale>& input) const
{
 ...
 */
void lowMSSM_slha_io::fill_drbar_parameters(MSSM_mass_eigenstates& model) const
{
 ...
 */
void lowMSSM_slha_io::fill(MSSM_mass_eigenstates& model) const
{
...
void lowMSSM_slha_io::fill_minpar_tuple(lowMSSM_input_parameters<Two_scale>& input,
...
void lowMSSM_slha_io::fill_extpar_tuple(lowMSSM_input_parameters<Two_scale>& input,
                                                int key, double value)
{
   switch (key) {
   default: WARNING("Unrecognized key: " << key); break;
 ...
 */
void lowMSSM_slha_io::fill_physical(MSSM_physical& physical) const
{
   {
