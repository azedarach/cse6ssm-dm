 ...
 * @brief implementation of the CMSSM two scale model class
 *
...
CLASSNAME::CMSSM(const CMSSM_input_parameters<Two_scale>& input_)
   : Two_scale_model()
...
const CMSSM_input_parameters<Two_scale>& CLASSNAME::get_input() const
{
   return input;
}

void CLASSNAME::set_input_parameters(const CMSSM_input_parameters<Two_scale>& input_)
{
   input = input_;
}
...
int CLASSNAME::tadpole_equations(const gsl_vector* x, void* params, gsl_vector* f)
{
   ...
   CMSSM<Two_scale>* model = ewsb_args->model;
