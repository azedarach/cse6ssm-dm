...
SuperFields[[15]] = {Hp, 1, {Hpd0, Hpdm},  -1/2, 2,  1, 2 / Sqrt[40], HpP, EpM};
SuperFields[[16]] = {Hpbar, 1, {Hpup, Hpu0}, 1/2, 2,  1, -2 / Sqrt[40], HpP, EpM};
...
SuperPotential = Yu u.q.Hu - Yd d.q.Hd - Ye e.l.Hd + \[Lambda] s.Hu.Hd + \[Lambda]12 s.H2I.H1I + \[Kappa] s.Dx.Dxbar + \[Mu]L Hpbar.Hp - \[Sigma] phi.s.sbar + \[Kappa]Pr/3 phi.phi.phi + \[Mu]Phi/2 phi.phi + \[Xi]F phi + fu SI.H1I.Hu + fd SI.Hd.H2I + gD q.Hp.Dxbar + hE e.H1I.Hp + \[Sigma]L phi.Hp.Hpbar;
...
DEFINITION[EWSB][MatterSector] = {
    ...
    {{SHpd0, conj[SHpu0]}, {SHp0, ZHp}},
    {{SHpdm, conj[SHpup]}, {SHpp, ZPp}},
    {{FHpd0, FHpu0}, {L0p, ZNp}}
};
